...
public class ImageBannerWidget extends AppWidgetProvider {
    ...
    private static final String TOAST_ACTION = "dicoding.adrian.submission4.TOAST_ACTION";
    public static final String EXTRA_ITEM = "dicoding.adrian.submission4.EXTRA_ITEM";
